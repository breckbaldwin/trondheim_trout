...
Based on: Sara Lutro’s 2025 MSc thesis “Trophically transmitted parasites as indicators for resource use in sea trout”

Can you author an R program that simulates the data generating process (DGP)? A simplified model is fine but obviously we will want: a- prey_abundance: Abundance of prey in Trondheimsfjorden for trout to eat--we can collapse the variations for now in the intitial DGP. b- prey_parasite_load: How full of parasites are the prey animals? Simplified for now to pool across all types of prey
